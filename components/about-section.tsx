        ...
        <div className="grid items-start gap-12 lg:grid-cols-2">
          ...
          <div>
            <p className="mb-6 text-lg leading-relaxed text-[#4a6078]">
              {"Η Εταιρία μας ασχολείται με μηχανουργικές εργασίες με εμπειρία 40 ετών. ��Εξειδικευόμαστε στην κατασκευή σωλήνων πιέσεως & μπουκάλων ανυψωτικών μηχανημάτων."}
            </p>
